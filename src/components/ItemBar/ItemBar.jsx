    ...
    <>
      <div className="item-bar-main large-screen">
        ...
        <div className="item-bar-right">
          ...
          <div
            className={`recommended-content ${showRecommended ? "show" : ""}`}
          >
            <span onClick={() => handleSorting("high-to-low")}>
              PRICE : HIGH TO LOW
            </span>
            <br />
            <span onClick={() => handleSorting("low-to-high")}>
              PRICE : LOW TO HIGH
            </span>
            <br />
            <span onClick={() => handleSorting("none")}>POPULAR</span>
            <br />
